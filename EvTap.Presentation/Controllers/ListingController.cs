...
namespace EvTap.Presentation.Controllers
{
    ...
    public class ListingController : ControllerBase
    {
        ...
        [HttpGet("GetListingByUserId")]
        public async Task<IActionResult> GetListingByUserId([FromQuery] string userId)
        {
            if (string.IsNullOrEmpty(userId))
                return BadRequest("User ID cannot be null or empty.");
            var listings = await _listingservice.GetListingByUSerId(userId);
