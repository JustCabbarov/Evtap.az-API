...
namespace EvTap.Persistence.Migrations
{
    ...
    [Migration("20250920145635_SomeEntitiesChanged")]
    partial class SomeEntitiesChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2280395f-2b6c-4966-bc41-91b9501035a0",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "f8c166a6-0f01-487e-8723-940d4bbb8e0e",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "4324c503-d7e9-4b64-8397-3ec01400b8cc",
                            Name = "Agency",
            ...
            modelBuilder.Entity("EvTap.Domain.Entities.ListingMetro", b =>
                {
                    ...
                    b.HasOne("EvTap.Domain.Entities.MetroStation", null)
                        .WithMany("ListingMetros")
